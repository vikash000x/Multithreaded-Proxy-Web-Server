...
//Parsing is the process of analyzing and interpreting the syntax of a text or program to extract relevant information. It involves breaking down a complex set of data structures or code into smaller, more manageable components that can be analyzed and understood.
...
// there is two types of file => .c,
// .h -> we have to declare what we are gonna do
...
/* 
   ...
   line.
 */
//not defination just declaration
...
//if we are going to do http req such as  google.com like HTTP 1.1/ GET/ host and we have to parse to it because 1 req has multiple things
// like method protocol and we have to extract address from it

// we are willing to implement our own server as a proxy server 
